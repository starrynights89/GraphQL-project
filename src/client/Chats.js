...
export default class Chats extends Component {
  ...
  openChat = (id) => {
    ...
    // GrapgQL API. Input is pushed to local cache, and the input 
    // is cleared. 
                  ...
                  return (
                    <div className="chatWindow">
                      ...
                      <Mutation
                        ...
                        {addMessage => (
                          <div className="input">
                            <input type="text" value={textInputs[chat.id]} onChange=
                            {(event) => self.onChangeChatInput(event, chat.id)} onKeyPress=
                            {(event) => {self.handleKeyPress(event, chat.id, addMessage)}}/>
                          </div>
                        )}
                      </Mutation>
                    </div>
